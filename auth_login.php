...
<body class='loginBody'>
	...
	<div class='loginCenter'  style="top:50px; background:#ffffff; max-height:500px; text-shadow:none;">
	<div class='loginArea'>
		<div class='cactiLoginLogo'></div>
			...
			<form id='login' name='login' method='post' action='<?php print get_current_page();?>'>
				...
				<div class='cactiLogin'>
					<table class='cactiLoginTable'  width="100%">
						<tr>
							<td colspan="2" style="padding-right:30px;">
								<label for='login_username'><?php print __('Username');?></label><br>
								<input type='text' id='login_username' name='login_username' style="width:100%; margin:10px 0; 
padding:9px 7px;" value='<?php print htmlspecialchars($username, ENT_QUOTES); ?>' placeholder='<?php print __esc('Username');?>'>
							</td>
						</tr>
						<tr>
							<td colspan="2" style="padding-right:30px;">
								<label for='login_password'><?php print __('Password');?></label><br>
								<input type='password' id='login_password' name='login_password' style="width:100%; margin:10px 
0; padding:9px 7px;" placeholder='********'>
							</td>
						</tr>
					<?php
					...
					<?php } ?>
						<tr>
							<td cospan='2'  style="padding-right:10px;">
								<input type='submit' value='<?php print __esc('Login');?>' style="width:100%; background:#03a9f4; border:0px; color:#fff; font-weight:bold; padding:10px 5px; text-transform:uppercase;">
							</td>
						</tr>
					</table>
				</div>
